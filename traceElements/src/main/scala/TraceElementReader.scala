...
private[traceElements] object TraceElementReader {
  ...
  implicit val systemOutPrintedReader: Reads[SystemOutPrinted] = Json.reads[SystemOutPrinted]
  implicit val systemErrPrintedReader: Reads[SystemErrPrinted] = Json.reads[SystemErrPrinted]
